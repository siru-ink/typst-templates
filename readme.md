...
| **USA-style CV** `usa-cv.typ` | Professional CV template tailored for US contexts with support for education, work experience, projects, and skills sections. Features customizable accent colors, consistent header on all pages, and proper US formatting conventions. | April 2026 |
